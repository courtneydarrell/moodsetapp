...
const moodlogRoutes: Routes= [
    {
        ...
        { path: 'calendar', component: NSEmptyOutletComponent,
        loadChildren: "~/app/moodlogs/calendar/calendar.module#CalendarModule", outlet: 'calendar'},
        { path: 'articles', component: NSEmptyOutletComponent,
        loadChildren:"~/app/articles/articles.module#ArticlesModule", outlet: 'articles'},
